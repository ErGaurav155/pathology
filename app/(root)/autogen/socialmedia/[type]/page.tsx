...
const AddTransformationTypePage = async ({
  ...
  return (
    <div className="flex items-center justify-center md:items-start md:justify-start flex-col md:flex-row wrapper2 gap-5">
      <div className="md:flex-auto w-2/3 md:min-h-screen scroll-m-4 overflow-y-scroll flex flex-col gap-5  md:px-7 pt-16">
      ...
      <div className="md:flex-auto h-[100vh] w-full md:w-2/6 p-12 md:p-0 pt-4 ">
